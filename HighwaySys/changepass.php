...
<head>
 ...
 <title>driving job post page</title>
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h3 class="modal-title" id="lineModalLabel">The nature of driving job</h3>
		</div>
		<div class="modal-body">
            ...
            <!-- content goes here -->
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Descriptions of job</label>
         <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <textarea style="resize:vertical;" class="form-control" placeholder="Like the driver will be operating along this route" rows="6" name="descriptions" required></textarea>
                                </div>
                            </div>
                                          </div>
...
<div class="row" style="clear:both">
 <div class="col-lg-12">
  ...
  <a href="changepass.php" class="list-group-item active" style="background-color:green;">Change Password
  </a>
