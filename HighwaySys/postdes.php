...
<head>
 ...
 <title>Highway management sytem</title>
...
<body>
 ...
 <a href="dpost.php" class="list-group-item active" style="background-color:green;">
        ...
        <div class="panel panel-white post panel-shadow">
            <div class="post-heading">
                <div class="pull-left image">
                    <img src="profpic/<?php echo $im; ?>" class="img-circle avatar" alt="user profile image">
                </div>
...
?>    
            ...
            <div class="post-footer">
                <div class="input-group"> 
                <textarea class="form-control" cols="100" rows="10" placeholder="Send us short application Message" type="text" name="applimsg"></textarea>
				...
				<button type="submit" name="submit_contact"  class="btn btn-primary btn-hover-green" >Submit application</button>
				</div>
                </div>
                </form> 
            </div>
